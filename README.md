...
You have to design & build the backend for the application and the ability for the users to register, search and log the issues.
...
https://github.com/azaylamba/jira 
